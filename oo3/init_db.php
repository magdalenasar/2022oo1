 ...
 * CREATE THE DATABASE
 */
$pdoDatabase = new PDO('mysql:host=127.0.0.1', $databaseUser, $databasePassword);
 ...
 * CREATE THE TABLE
 */
$pdo = new PDO('mysql:host=127.0.0.1;dbname='.$databaseName, $databaseUser, $databasePassword);
